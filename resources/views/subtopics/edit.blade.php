<x-app-layout>
    <section class="content-header">
        <h1>
            Edit Subtopic
            <small>Modify the existing subtopic</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{ route('subtopics.index') }}">Subtopics</a></li>
            <li class="active">Edit Subtopic</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <form action="{{ route('subtopics.update', $subtopic->id) }}" method="POST">
                        @csrf
                        @method('PUT') <!-- This is important for PUT method as you're updating -->
                        <div class="box-body">
                            <div class="form-group">
                                <label for="name">Subtopic Name</label>
                                <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $subtopic->name) }}" placeholder="Enter Subtopic Name" required>
                            </div>
                            ...
                            <div>
                                <textarea class="textarea" placeholder="Description" name="description" id="editor"
                                    ...
                                    {{ old('description', $subtopic->description) }}
                                </textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-info">Update Subtopic</button>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
